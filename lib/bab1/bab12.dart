...
class PageBab12 extends StatelessWidget {
  const PageBab12({Key? key}) : super(key: key);
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 20,),
                    Image.asset('assets/bab121.png',
                      ),
                    SizedBox(height: 15,),
                    Text('Dan untuk definisi perbandingan trigonometri sudut siku-siku kedua, adalah:',
                      style: TextStyle(
                        fontSize: 13,
                        fontFamily: ('Space Mono'),
                      ),
